...
Ext.define('Techsupport.view.sysadmin.Login', {
    ...
    items: [
        ...
        {xtype: 'form', region: 'center', defaults: {margin: "5 5 0 15%", labelWidth: "25%"}, items: [
            {xtype: 'textfield', fieldLabel: '帐号', name: 'useraccount', maxLength: 20,
                allowBlank: false, anchor: "90%"},
            {xtype: 'textfield', fieldLabel: '密码', name: 'password', maxLength: 20,
                inputType: 'password', allowBlank: false, anchor: "90%"},
