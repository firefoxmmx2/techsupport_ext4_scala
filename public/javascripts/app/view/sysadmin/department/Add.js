        ...
        {xtype: 'form',
            ...
            {xtype: 'panel',
                ...
                items: [
                    ...
                    {fieldLabel: '机构全码', name: 'departfullcode', allowBlank: false, blankText: '机构全码不能为空',readOnly:true},
                    {fieldLabel: '上级机构id', name: 'parentDepartid', allowBlank: false, blankText: '上级机构id不能为空', hidden: true,readOnly:true},
